BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE RFLOW.RF_S248_E_201809_2_1_0';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE RFLOW.RF_S248_E_201809_3_1_0';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE RFLOW.RF_S248_E_201809_4_1_0';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
--Feladat 2
create table RFLOW.RF_S248_E_201809_2_1_0 as
select
    cast('Éves' as varchar2(10)) IDO_TIP
    ,IDOSZAK
    ,BNO
    ,A_TCS
    ,A_NEV.HATOANYAG A_HATOANYAG
    ,A_NEV.BRAND A_BRAND
    ,A_TTT
    ,A_NEV.NEV A_TTT_NEV
    ,B_TCS
    ,B_NEV.HATOANYAG B_HATOANYAG
    ,B_NEV.BRAND B_BRAND
    ,B_TTT
    ,B_NEV.NEV B_TTT_NEV
...
from
    ...
    left outer join RFLOW.RF_S248_TTT A_NEV on precalc.A_TTT = A_NEV.TTT
    left outer join RFLOW.RF_S248_TTT B_NEV on precalc.B_TTT = B_NEV.TTT
order by
    IDOSZAK
    ,BNO
    ,A_TCS
...
--Feladat 3
create table RFLOW.RF_S248_E_201809_3_1_0 as
select
    cast('Éves' as varchar2(10)) IDO_TIP
    ,IDOSZAK
    ,BNO
...
--Feladat 4
create table RFLOW.RF_S248_E_201809_4_1_0 as
select
    '0 nap - 2 hónap' KATEG
    ,cast('Éves' as varchar2(10)) IDO_TIP
    ,IDOSZAK
