BEGIN
   EXECUTE IMMEDIATE 'DROP TABLE RFLOW.RF_S248_E_201809_5_1_0_BNO';
EXCEPTION
   WHEN OTHERS THEN
      IF SQLCODE != -942 THEN
         RAISE;
...
create index ix_E_5_TMP_BNO on RFLOW.RF_S248_E_201809_5_TMP(BNO);
    
--Brand
create table RFLOW.RF_S248_E_201809_5_1_0_BNO as
select
    '5/A' KATEG
...
insert into
    RFLOW.RF_S248_E_201809_5_1_0_BNO
select
    '5/A' KATEG
    ,Aalap.EV IDOSZAK
    ,Aalap.BNO A_BNO
